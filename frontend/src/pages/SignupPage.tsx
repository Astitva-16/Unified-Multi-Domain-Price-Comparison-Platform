    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-6">
          ...
          <p className="text-muted-foreground text-sm mt-1">Start comparing prices today</p>
        </div>
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="relative">
            <Lock size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
            <Input placeholder="Confirm password" type={showPw ? "text" : "password"} className="pl-10" />
          </div>
          <Button className="w-full gradient-primary text-primary-foreground border-0">Create Account</Button>
        </form>
